...
from app.views.upload_file import MOD_UPLOAD_FILE
from app.views.delete_file import MOD_DELETE_FILE
...
APP.register_blueprint(MOD_UPLOAD_FILE)
APP.register_blueprint(MOD_DELETE_FILE)
